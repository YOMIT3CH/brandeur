...
export const LogoIcon = ({ className = "w-6 h-6" }) => (
    <div className={`relative group-hover:scale-110 transition-transform duration-300 ${className}`}>
        <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-400 rounded-lg blur opacity-30 group-hover:opacity-60 transition duration-300" />
        <svg className="relative text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
...
export const BoltIcon = ({ className = "w-6 h-6" }) => (
    <svg className={`${className} text-blue-600 animate-bounce`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const GlobeIcon = ({ className = "w-6 h-6" }) => (
    <svg className={`${className} text-blue-600 animate-[spin_8s_linear_infinite]`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
